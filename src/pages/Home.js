...
import { Checkbox } from "@mui/utils";
...
class Home extends Component {
  ...
  /****HERE****Check for items in todo list*******/
  todo.id = Math.random();
  let new_list;
  ...
  render() {
    return (
      <div className="Home">
        ...
        <Todos todos={this.state.todos} deleteTodo={this.deleteTodo} /****HERE****replace (make your change) with deleteTodo() functi*******/ />
      </div>
    );
  }
}
